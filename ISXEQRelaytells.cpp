...
#include "ISXEQRelaytells.h"

// The mandatory pre-setup function.  Our name is "ISXEQRelaytells", and the class is ISXEQRelaytells.
...
// our instanced class.
ISXPreSetup("ISXEQRelaytells",ISXEQRelaytells);
...
unsigned int ISXEQRelaytellsXML=0;
...
bool ISXEQRelaytells::Initialize(ISInterface *p_ISInterface)
...
WriteChatf("ISXEQRelaytells Loaded");
return true;
}

// shutdown sequence
void ISXEQRelaytells::Shutdown()
{
    // save settings, if you changed them and want to save them now.  You should normally save
    // changes immediately.
    //pISInterface->ExportSet(ISXEQRelaytellsXML,XMLFileName);

    pISInterface->UnloadSet(ISXEQRelaytellsXML);
...
void ISXEQRelaytells::ConnectServices()
{
...
void ISXEQRelaytells::RegisterCommands()
{
    // add any commands
...
void ISXEQRelaytells::RegisterAliases()
{
    // add any aliases
}

void ISXEQRelaytells::RegisterDataTypes()
{
    // add any datatypes
    // pMyType = new MyType;
...
void ISXEQRelaytells::UnRegisterCommands()
{
    // remove commands
    //    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQRelaytells::UnRegisterAliases()
{
    // remove aliases
}
void ISXEQRelaytells::UnRegisterDataTypes()
{
    // remove data types
    //if (pMyType)
    //{
...
void ISXEQRelaytells::UnRegisterTopLevelObjects()
{
    // remove Top-Level Objects
    //    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQRelaytells::UnRegisterServices()
{
    // shutdown our own services
    //    if (hISXEQRelaytellsService)
    //        pISInterface->ShutdownService(this,hISXEQRelaytellsService);
}

void ISXEQRelaytells::LoadSettings()
{
    bool bChanged=false;

    // open the settings file, and store the ID number in ISXEQRelaytellsXML
    ISXEQRelaytellsXML=pISInterface->OpenSettings(XMLFileName);
    ...
    Any set can be referred to by its ID.  The base set is stored in ISXEQRelaytellsXML.  Note that the settings
    ...
    */
    ...
    if (unsigned int GeneralGUID=pISInterface->FindSet(ISXEQRelaytellsXML,"General"))
    {
